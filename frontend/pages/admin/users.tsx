            ...
            {formRole === "student" ? (
              <div className="space-y-6">
                <div className="rounded-[1.2rem] border border-soft p-5">
                  <p className="mb-4 text-xs uppercase tracking-[0.2em] text-[var(--accent)] font-semibold">1. Student & Academic Details</p>
                  <div className="grid gap-4 md:grid-cols-2">
                    <input className="rounded-[1.2rem] border border-soft bg-surface-strong px-4 py-3 outline-none" onChange={(e) => setForm(c => ({...c, profile: {...c.profile, dob: e.target.value}}))} placeholder="Date of Birth" value={form.profile.dob} type="date" />
                    ...
                    <input className="rounded-[1.2rem] border border-soft bg-surface-strong px-4 py-3 outline-none md:col-span-2" onChange={(e) => setForm(c => ({...c, profile: {...c.profile, photoUrl: e.target.value}}))} placeholder="Recent Passport Size Photo URL" value={form.profile.photoUrl} />
                    ...
                    <select className="rounded-[1.2rem] border border-soft bg-surface-strong px-4 py-3 outline-none md:col-span-2" onChange={(e) => setForm(c => ({...c, profile: {...c.profile, board: e.target.value}}))} value={form.profile.board}>
                      <option value="">Select Board (CBSE/MP Board/ICSE)</option>
                ...
                <div className="rounded-[1.2rem] border border-soft p-5">
                  <p className="mb-4 text-xs uppercase tracking-[0.2em] text-[var(--accent)] font-semibold">2. Parent / Guardian Details</p>
                  <div className="grid gap-4 md:grid-cols-2">
                    ...
                    <div className="flex flex-col">
                      ...
                      <input className="rounded-[1.2rem] border border-soft bg-surface-strong px-4 py-3 outline-none" onChange={(e) => setForm(c => ({...c, profile: {...c.profile, tuitionStartDate: e.target.value}}))} type="date" value={form.profile.tuitionStartDate} />
                    </div>
                  </div>
                </div>

                <div className="rounded-[1.2rem] border border-soft p-5">
                  <p className="mb-4 text-xs uppercase tracking-[0.2em] text-[var(--accent)] font-semibold">3. Office Use Only</p>
                  <div className="grid gap-4 md:grid-cols-2">
                    <input className="rounded-[1.2rem] border border-soft bg-surface-strong px-4 py-3 outline-none" onChange={(e) => setForm(c => ({...c, profile: {...c.profile, admissionNumber: e.target.value}}))} placeholder="Admission No." value={form.profile.admissionNumber} />
                    <div className="flex flex-col">
                    ...
                    <select className="rounded-[1.2rem] border border-soft bg-surface-strong px-4 py-3 outline-none md:col-span-2" onChange={(e) => setForm(c => ({...c, profile: {...c.profile, feesPlan: e.target.value}}))} value={form.profile.feesPlan}>
                    ...
                    <input className="rounded-[1.2rem] border border-soft bg-surface-strong px-4 py-3 outline-none" onChange={(e) => setForm(c => ({...c, profile: {...c.profile, customStudentId: e.target.value}}))} placeholder="Student ID" value={form.profile.customStudentId} />
                  </div>
                </div>
              </div>
            ) : formRole === "teacher" ? (
