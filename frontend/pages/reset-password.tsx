    ...
    <div className="flex min-h-screen flex-col px-4 py-6 md:px-8">
      ...
      <div className="mx-auto flex w-full max-w-md flex-1 flex-col justify-center pb-12">
        ...
        <div className="app-shell-card rounded-[2rem] p-6 md:p-8 w-full">
          <p className="text-xs uppercase tracking-[0.28em] text-muted">Password reset</p>
          <h1 className="heading-serif mt-4 text-4xl">Choose a new password</h1>
          <p className="mt-4 text-sm leading-7 text-muted">
            Reset the account password securely, then sign back in with the updated credentials.
          </p>
          ...
          {token ? (
            ...
            <div className="mt-8 rounded-[1.4rem] border border-soft px-4 py-4 text-sm text-muted">
              This reset link is incomplete or expired. Request a fresh password reset link from the login screen.
            </div>
          )}
